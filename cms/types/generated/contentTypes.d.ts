...
export interface ApiAppSettingAppSetting extends Schema.CollectionType {
  ...
  info: {
    description: 'Global dashboard defaults and guest-facing settings';
  ...
  attributes: {
    appearance: Attribute.Component<'app.default-appearance'> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiClimateLayerClimateLayer extends Schema.CollectionType {
  ...
  info: {
    displayName: 'Climate Layer';
    pluralName: 'climate-layers';
    singularName: 'climate-layer';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    colormap: Attribute.String & Attribute.DefaultTo<'Blues'>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::climate-layer.climate-layer',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
    geotiff: Attribute.Media<'files'>;
    max_value: Attribute.Float;
    metadata: Attribute.JSON;
    min_value: Attribute.Float;
    model: Attribute.String;
    period_end: Attribute.Date;
    period_start: Attribute.Date;
    ...
    > &
      Attribute.Private;
    variable: Attribute.String & Attribute.Required;
  };
}

export interface ApiForecastForecast extends Schema.CollectionType {
  ...
  attributes: {
    bias_corrected: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    > &
      Attribute.Private;
    ensemble_member: Attribute.Integer;
    issued_at: Attribute.DateTime & Attribute.Required;
    lead_time_days: Attribute.Integer & Attribute.Required;
    model: Attribute.String;
    ...
    > &
      Attribute.Private;
    valid_at: Attribute.DateTime & Attribute.Required;
    value: Attribute.Float & Attribute.Required;
    variable: Attribute.Enumeration<
      ['flow_m3s', 'level_m', 'precipitation_mm', 'water_surface_elevation_m']
    > &
      Attribute.Required;
  };
}
...
export interface ApiMeasurementMeasurement extends Schema.CollectionType {
  ...
  attributes: {
    ...
    quality_flag: Attribute.Integer & Attribute.DefaultTo<0>;
...
export interface ApiStationStation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    altitude_m: Attribute.Float;
    basin: Attribute.String;
    ...
    publishedAt: Attribute.DateTime;
    river: Attribute.String;
    source: Attribute.Enumeration<['ANA', 'HydroWeb', 'SNIRH', 'Virtual']> &
      Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::station.station',
...
export interface ApiUserPreferenceUserPreference extends Schema.CollectionType {
  ...
  attributes: {
    alerts: Attribute.Component<'preferences.alert-settings'>;
    appearance: Attribute.Component<'preferences.appearance-settings'>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    > &
      Attribute.Private;
    favoriteStations: Attribute.Relation<
      'api::user-preference.user-preference',
      'manyToMany',
      'api::station.station'
    >;
